...
namespace Obshepit
{
    public partial class Recipe : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                myConnection.Open();
                SqlCommand dob = new SqlCommand($"UPDATE Recipe SET cooking_time = {int.Parse(textBox2.Text)}, cooking_technology = '{textBox3.Text}' WHERE id= {int.Parse(textBox1.Text)}");
                dob.Connection = myConnection;
                dob.ExecuteNonQuery();
                myConnection.Close();
            }
            Recipe_Load(sender, e);
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                myConnection.Open();
                SqlCommand dob = new SqlCommand($"INSERT INTO Recipe values( {int.Parse(textBox2.Text)}, '{textBox3.Text}')");
                dob.Connection = myConnection;
                dob.ExecuteNonQuery();
                myConnection.Close();
            }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                myConnection.Open();
                string cmd = "DELETE FROM Recipe WHERE id = @code";
