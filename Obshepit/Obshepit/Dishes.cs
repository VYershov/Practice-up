...
namespace Obshepit
{
    public partial class Dishes : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                myConnection.Open();
                SqlCommand dob = new SqlCommand($"UPDATE Dishes SET name_dish = '{textBox2.Text}', type_dish = {int.Parse(textBox3.Text)}, portion_grams =  {int.Parse(textBox4.Text)} WHERE id= {int.Parse(textBox1.Text)}");
                dob.Connection = myConnection;
                dob.ExecuteNonQuery();
                myConnection.Close();
            }
            Dishes_Load(sender, e);
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                myConnection.Open();
                SqlCommand dob = new SqlCommand($"INSERT INTO Dishes values( '{textBox2.Text}', {int.Parse(textBox3.Text)}, {int.Parse(textBox4.Text)})");
                dob.Connection = myConnection;
                dob.ExecuteNonQuery();
                myConnection.Close();
            }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                myConnection.Open();
                string cmd = "DELETE FROM Dishes WHERE id = @code";
