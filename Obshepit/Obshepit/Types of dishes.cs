...
namespace Obshepit
{
    public partial class Types_of_dishes : Form
    {
        ...
        string sql = "Select * from Types_of_dishes";

        public Types_of_dishes()
        {
            InitializeComponent();
        }

        private void Types_of_dishes_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                myConnection.Open();
                SqlCommand dob = new SqlCommand($"UPDATE Types_of_dishes SET name_types = '{textBox2.Text}' WHERE id= {int.Parse(textBox1.Text)}");
                dob.Connection = myConnection;
                dob.ExecuteNonQuery();
                myConnection.Close();
            }
            Types_of_dishes_Load(sender, e);
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                myConnection.Open();
                SqlCommand dob = new SqlCommand($"INSERT INTO Types_of_dishes values( '{textBox2.Text}' ");
                dob.Connection = myConnection;
                dob.ExecuteNonQuery();
                myConnection.Close();
            }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                myConnection.Open();
                string cmd = "DELETE FROM Types_of_dishes WHERE id = @code";
